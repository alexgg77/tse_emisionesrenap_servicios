...
@Repository
@Transactional
public interface SolicitudCertificadoRepositorio <T> 
    ...
    boolean existsByesVerificadoAndCreatedBy(Boolean esVerificado, Long createdBy);
    boolean existsByesFinalizadoAndEsVerificadoAndEsRechazadoAndCreatedBy(Boolean esFinalizado,Boolean esVerificado,Boolean esRechazado, Long createdBy);
